...
- [[Heliostat_StudyLog]] — Running learning log for building the Q1 Python model myself (concept-first). Build order, worked intuitions, resume pointer. Currently on **Step 1 (solar geometry)**. In `Inbox/`.
